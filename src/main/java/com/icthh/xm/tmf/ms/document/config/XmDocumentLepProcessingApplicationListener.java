...
@Component
public class XmDocumentLepProcessingApplicationListener extends SpringLepProcessingApplicationListener {
    ...
    public XmDocumentLepProcessingApplicationListener(TenantConfigService tenantConfigService,
